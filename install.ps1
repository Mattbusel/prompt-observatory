# Install Prompt Observatory on Windows from the latest GitHub release.
#
#   irm https://raw.githubusercontent.com/Mattbusel/prompt-observatory/master/install.ps1 | iex
#
# It downloads the Windows zip, checks it against the release's SHA256SUMS.txt,
# puts prompt-observatory.exe in %LOCALAPPDATA%\Programs\prompt-observatory and adds that folder to
...
$Prefix = 'prompt-observatory'
$Bin    = 'prompt-observatory'
$Cmd    = 'prompt-observatory'
...
Write-Host "Try it: prompt-observatory   (open a new terminal if the command is not found)"
